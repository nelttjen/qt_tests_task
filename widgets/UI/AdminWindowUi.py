...
class AdminWindowUi:
    ...
    def __init__(self):
        ...
        self.test_file_confirm_btn = QPushButton(self)
        self.test_file_confirm_btn.setText(Strings.AdminUi.test_file_confirm_btn)
        self.test_file_confirm_btn.setGeometry(centralizate(self.Meta.WINDOW_WIDTH, 200), 450, 200, 75)
        self.test_file_confirm_btn.setFont(get_font(15))

        self.exel_export_checkbox = QCheckBox(self)
        self.exel_export_checkbox.setText(Strings.AdminUi.exel_import_checkbox)
        self.exel_export_checkbox.setGeometry(centralizate(self.Meta.WINDOW_WIDTH, 750), 25, 750, 25)
        self.exel_export_checkbox.setFont(get_font(10))
        self.exel_export_checkbox.setChecked(True)
